...
public class VerificadoresRegEx {
    ...
    private static Pattern verificadorIDs = Pattern.compile("(^[1-9]*)$"); //nessa classe eu estou instanciando um Patter.compole que será o objeto que sera utilizado no matcher para realizar a verificação da RegEx
