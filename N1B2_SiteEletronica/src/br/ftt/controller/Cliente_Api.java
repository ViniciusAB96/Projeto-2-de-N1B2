...
/**
 * Servlet implementation class Cliente_Api
 */
...
public class Cliente_Api extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ClienteDAO clienteDAO = new ClienteDAO(); // objeto retorno do DAO
		...
		Gson clienteGson = new GsonBuilder().create(); //cria objeto Gson
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		ClienteDAO clienteDAO = new ClienteDAO(); // objeto retorno do DAO
		clienteDAO.excluir(request.getParameter("cpf")); // VO recebendo DAO
	}
